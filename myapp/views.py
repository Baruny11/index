...
from myapp.models import Contact, Dish, Team, Category, Profile, Order, Reservation
...
def cancel_booking(request, pk):
    ...
    if request.method == "POST":
        reservation.delete()
        context['message'] = "Your reservation has been cancelled successfully!"
...
def show_reservations(request):
    ...
    if request.user.is_authenticated:
        ...
        context['message'] = "Please log in to view your reservations."
...
def new_booking(request):
    ...
    if request.method=="POST":
        ...
        obj = Reservation(name=name, email=email, phone=phone, date=date, time=time, number_of_guests=guests, special_requests=special,table_number=table)
        obj.save()
        context['message'] = f"Dear {name}, Your Table is Booked Successfully!"
...
def single_dish(request, id):
    ...
    if request.user.is_authenticated:
        ...
        # Create forms for PayPal and eSewa payments
